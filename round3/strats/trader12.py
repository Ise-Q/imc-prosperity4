...
PARAMS = {
    HYDROGEL: {
        ...
        "take_margin": 2,
        "clear_margin": 6,
        "make_margin": 5,            # was 6 — tighten 1 tick
    },
}
...
class OptionTrader(ProductTrader):
    ...
    def get_orders(self):
        ...
        # trader12: relax deep-ITM intrinsic-take to <= (was strict <)
...
class HedgeTrader(ProductTrader):
    ...
    def _post_mm(self):
        ...
        bb, ba = self.get_best_bid(), self.get_best_ask()
        levels = [
            (margin,     size_frac * 0.4),
            (margin + 2, size_frac * 0.5),
            (margin + 5, size_frac * 0.7),
        ]
